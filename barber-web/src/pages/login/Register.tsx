...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Registrar barbero
      await api.post("/auth/registro-barbero", {
        nombre,
        email,
        password,
      });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="bg-white w-full max-w-md p-8 rounded-2xl shadow-lg">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 mt-1">Registro para Barberos</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={cargando}
            className="w-full bg-blue-600 text-white py-2.5 rounded-lg font-semibold hover:bg-blue-700 disabled:bg-gray-400 transition shadow mt-2"
          >
